...
{
    public static final String carpetVersion = PlatformCompat.getCarpetVersion();
    public static final int [] releaseTarget =  {
            PlatformCompat.getMinecraftVersionComponents()[0],
            PlatformCompat.getMinecraftVersionComponents()[1]
    };
